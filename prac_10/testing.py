...
def run_tests():
    ...
    assert test_car_1.fuel == 10, "Fuel not correctly set with custom value"

    test_car_2 = Car()
    assert test_car_2.fuel == 0, "Default fuel not correctly set"
...
def format_sentence(phrase):
    ...
    'It is an ex parrot.'
    >>> format_sentence('my name is ewa')
    'My name is ewa.'
    """
    if phrase[0].islower():
